/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 484e1fbed2c83cb4f20684168aa20da1)
// Runtime types generated with workerd@1.20260617.1 2026-06-22 nodejs_compat
interface __BaseEnv_Env {
	RATE_LIMITER: RateLimit;
	LOADER: WorkerLoader;
	ASSETS: Fetcher;
	LOADER_COMPAT_DATE: "2026-06-22";
	TURNSTILE_SITEKEY: "1x00000000000000000000AA";
	TURNSTILE_SECRET: string;
	ENVIRONMENT: string;
	LOG_SESSION: DurableObjectNamespace<import("./src/index").LogSession>;
	STORAGE_HOST: DurableObjectNamespace<import("./src/index").StorageHost>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LogSession" | "StorageHost";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOADER_COMPAT_DATE" | "TURNSTILE_SITEKEY" | "TURNSTILE_SECRET" | "ENVIRONMENT">> {}
}
